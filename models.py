...
def extract_frames(path,file_name, model, class_names, width, height, savename, gt, device):
    ...
    for ele in enumerate(c1_frame_no):
        ...
        im = "/home/dissana8/Naturalistic-Adversarial-Patch/eval_output/LAB_adYolo_yolov4_0.1/cam1/"+ele[1]
    ...
    for ele in enumerate(c2_frame_no):
        ...
        #adversarial images Naturalistic patch
        im = "/home/dissana8/Naturalistic-Adversarial-Patch/eval_output/LAB_adYolo_yolov4_0.1/cam2/"+ele[1]
...
#     # view 03 success rate
    ...
    for ele in enumerate(c3_frame_no):
        ...
        #adversarial images Naturalistic patch
        im = "/home/dissana8/Naturalistic-Adversarial-Patch/eval_output/LAB_adYolo_yolov4_0.1/cam3/"+ele[1]
...
#     # view 04 success rate
    ...
    for ele in enumerate(c4_frame_no):
        ...
        #adversarial images Naturalistic patch
        im = "/home/dissana8/Naturalistic-Adversarial-Patch/eval_output/LAB_adYolo_yolov4_0.1/cam4/"+ele[1]
    ...
    f = open("detections_adYolo_yolov4_0.1.txt", "a")
...
if __name__ == "__main__":
    ...
    #adversarial images Naturalistic patch
    path = "/home/dissana8/Naturalistic-Adversarial-Patch/eval_output/LAB_adYolo_yolov4_0.1/"
    ...
    f = open("success_rate_adYolo_yolov4_0.1.txt", "a")
